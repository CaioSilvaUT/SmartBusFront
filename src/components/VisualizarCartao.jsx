      ...
      {depositar && (
        <div className="fixed inset-0 bg-green-100 bg-opacity-60 p-8 flex items-center justify-center overflow-y-auto z-50">
          <div className="bg-white p-8 rounded w-full max-w-lg relative">
            <button
              onClick={handleClose}
              className="absolute top-2 right-2 text-black text-xl hover:text-grey transition duration-300"
            >
              ×
            </button>
            ...
            <label
              htmlFor="Valoratual"
              className="font-bold font-inter block text-black flex flex-row"
            >
              Valor atual: R${resData.valor}
            </label>
            <label
              htmlFor="Valoracolocar"
              className="font-bold font-inter block text-grey flex flex-row mb-3"
            >
              Insira no campo abaixo quanto você deseja depositar:
            </label>
            <input
              type="number"
              step=".01"
      ...
      {renovar && (
        <div className="fixed inset-0 bg-green-100 bg-opacity-60 p-8 flex items-center justify-center overflow-y-auto z-50">
          <div className="bg-white p-8 rounded w-full max-w-lg relative">
            ...
            <h2 className="text-2xl font-inter font-semibold text-green-400 mb-2">
              Renovar Carteirinha
            </h2>
